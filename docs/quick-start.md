...
spec:
  topology:
    ...
    #    oidc:
    #      issuerUrl: "https://login.microsoftonline.com/9c508e11-7562-4ea9-95e5-4c00aa6d1b13/v2.0"
    #      clientId: "960c6f04-4468-4dc9-962c-7d7fb3bcde83"
    #      usernameClaim: "email"
    #      groupsClaim: "groups"
    #- name: ciliumHelmValues
    #  value: 
    #    ipv6:
    #      enabled: true
